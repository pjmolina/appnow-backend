...
angular.module('myApp').controller('ImportController', function ($scope, $routeParams, $location, NavigationService, ImportService) {
	...
	*/
	...
	$scope.cancel = function () {
		...
		var url = NavigationService.pop() || '/'+$scope.className+'/list';
		$location.path(url);
	};
